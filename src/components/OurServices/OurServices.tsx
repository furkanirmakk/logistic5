        ...
        {products.map((services) => (
          ...
          >
            <div className="relative">
              ...
              />
              <div className="absolute bottom-0 w-full bg-gray-400 text-gray-800 text-center py-2 transition-all duration-300 transform opacity-100 group-hover:translate-y-[-100%] group-hover:opacity-100">
